...
for number in range(5):
    ...
    imageCopies.append(frameCopy)
    

frameWidth = images[0].shape[1]
frameHeight = images[1].shape[0]
threshold = 0.1
...
for number in range(len(images)):
    ...
    for i in range(nPoints):
        ...
        frameCopy = imageCopies[number]
        probMap = output[number, i, :, :]
    ...
    print(x)
    cv2.imwrite('frame-keypoints' + str(number) + '.jpg', frameCopy)
